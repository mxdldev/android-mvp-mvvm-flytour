...
### 更新日志：
### [FlyTour 5.0.0【组件化+MVP+Kotlin标准版】](https://github.com/mxdldev/android-mvp-flytour-kotlin) 2020-02-18
该版本是在2.0.0的基础上对所有的功能用Kotlin语言进行了重新的编写
* 对所有功能用Kotlin重新编写
