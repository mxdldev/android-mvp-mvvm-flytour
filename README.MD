...
该版本是在2.0.0的基础上运用VirtualAPK框架对整个项目进行插件化改造，完美的实现了组件化到插件化的完美升级，关于组件化和插件化请查阅[Android组件化方案最佳实践](https://menxindiaolong.blog.csdn.net/article/details/86604852)这篇文章
