 ...
 * Update:     <br>
 */
public abstract class BaseMvvmFragment1<V extends ViewDataBinding,VM extends BaseViewModel> extends BaseFragment1 {
    ...
    public void initCommonView(ViewGroup root) {
